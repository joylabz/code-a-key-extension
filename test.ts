...
input.onButtonPressed(Button.A, function () {
  ...
  makeyMakey.moveMouseForMilliseconds(makeyMakey.MouseDirections.Left, 500)
  makeyMakey.clickMouse(makeyMakey.MouseButtons.Left)
  makeyMakey.moveMouseForMilliseconds(makeyMakey.MouseDirections.Right, 500)
  makeyMakey.moveMouseForMilliseconds(makeyMakey.MouseDirections.Up, 500)
  makeyMakey.moveMouseForMilliseconds(makeyMakey.MouseDirections.Down, 500)
})